function solve_SI_pde()
    ...
    %------------------------------------------------------------------
    t_min_plot =10000;    % minimum t to include in surface plot
    t_max_plot = 15000;   % maximum t to include in surface plot

    %------------------------------------------------------------------
    % 1. Model Parameters
    %------------------------------------------------------------------
    beta = 12 ;  % Transmission rate
    d    = 1;                     % Natural death rate
    mu0  = 2;                      % Min disease-induced mortality
    mu1  = 10;                       % Max disease-induced mortality
    b    = 0.052277264;                     % Half-saturation constant
    A    = 1;                        % Recruitment rate
    r1   = 0.03;                     % Diffusion coefficient for S
